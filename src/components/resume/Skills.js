    ...
    >
      <div className="w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          ...
          <h2 className="text-3xl md:text-4xl font-bold">Languages/DSA/Technology</h2>
        </div>
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                className=" w-[90%] w-full h-full bg-gradient-to-r from-blue-600 via-pink-500 to-red-500 rounded-md relative"
              >
                <span className="absolute -top-7 right-0">Advanced</span>
              </motion.span>
            </span>
          </div>
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              ...
              >
                <span className="absolute -top-7 right-0">Intermidiate</span>
              </motion.span>
            </span>
          </div>
          <div className="overflow-x-hidden">
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[80%] w-full h-full bg-gradient-to-r from-blue-600 via-pink-500 to-red-500 rounded-md relative"
              >
                <span className="absolute -top-7 right-0">Intermidiate</span>
              </motion.span>
            </span>
      ...
      <div className="w-full lgl:w-1/3">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          ...
          <h2 className="text-3xl md:text-4xl font-bold">Interested Fields</h2>
        </div>
        <div className="flex flex-col gap-6">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Keras</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm  font-medium">solving Machine Learning and Deep Learning real problems&nbsp;Intermidiate</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
                ...
                className="w-[75%] h-full bg-gradient-to-r from-blue-600 via-pink-500 to-red-500 rounded-md relative"
              >
                <span className="absolute -top-7 right-180"></span>
              </motion.span>
            </span>
          </div>
